      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-600 py-6 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="/signup" className="whitespace-nowrap text-base font-medium text-gray-300 hover:text-gray-400">
              Sign up
            </a>
            <a href="/signin" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-700 hover:bg-red-800">
              Sign in
            </a>
          </div>
        </div>
        ...
        <Popover.Panel focus className="absolute top-0 inset-x-2 p-4 transition transform origin-top-right md:hidden">
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-slate-900 divide-y-2 divide-gray-50">
            ...
            <div className="py-6 px-5 space-y-6">
              ...
              <div>
                <a href="/signin" className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-700 hover:bg-red-800">
                  Sign in
                </a>
                <p className="mt-4 text-center text-base font-medium text-gray-400">
                Don't have an account?{' '}
                  <a href="/signup" className="text-red-700 hover:text-red-800">
                    Sign up
                  </a>
                </p>
              </div>
